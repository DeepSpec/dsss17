...
# coq_makefile OTHERFLAGS = -R . LF COQLIBS =  -install none Preface.v Basics.v Induction.v Lists.v Poly.v Tactics.v Logic.v IndProp.v Maps.v ProofObjects.v IndPrinciples.v Rel.v Imp.v ImpParser.v ImpCEvalFun.v Extraction.v Auto.v Postscript.v Bib.v -o Makefile 
#
...
.merlin:
	...
	@echo "B /Users/bcpierce/work/sf/new/lf/full" >> .merlin
	@echo "S /Users/bcpierce/work/sf/new/lf/full" >> .merlin
