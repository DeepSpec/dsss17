...
Section ASSOC.
  ...
  Lemma in_assoc_none : forall l a b,
    assoc a l = None -> ~In (a, b) l.
  Proof.
    induction l; intros a1 b1 H.
    - apply in_nil.
    - rewrite not_in_cons.
      split.
      + destruct a as [a0 b0].
        simpl in H.
        destruct (eq_dec a1 a0).
        * inversion H.
        * unfold not. intros He. apply n. inversion He. reflexivity.
      + destruct a as [a0 b0].
        simpl in H.
        destruct (eq_dec a1 a0).
        * inversion H.
